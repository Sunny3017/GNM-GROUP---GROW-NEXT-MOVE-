...
import { 
    Save, ArrowLeft, Upload, X, CheckCircle2, 
    Info, Layers, PlusCircle
} from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50 pb-24">
            <div className="bg-primary-dark text-white py-12 mb-12">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <Link to="/admin/manage" className="inline-flex items-center text-gray-400 hover:text-white mb-6 transition-colors">
                        <ArrowLeft size={20} className="mr-2" /> Back to Management
                    </Link>
                    <h1 className="text-4xl font-serif font-bold">Edit Property</h1>
                    <p className="text-gray-400 mt-2">Update details for: {formData.title}</p>
                </div>
            </div>
